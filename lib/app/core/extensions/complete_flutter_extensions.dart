    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: isSelected
              ? Border.all(color: selectionColor ?? primaryColor, width: 2)
              : null,
        ),
        child: ClipRRect(
          borderRadius: borderRadius ?? radius2,
          child: isAsset
              ? assetImage(imageUrl, width: size, height: size, fit: fit)
              : networkImage(imageUrl, width: size, height: size, fit: fit),
        ),
      ),
    );
  }
...
extension WidgetExtensions on Widget {
  ...
  Widget rotateIn({
    ...
    curve: curve,
    builder: (context, value, child) =>
        Transform.rotate(angle: value * 2 * 3.14159, child: this),
  );
...
extension StringExtensions on String {
  ...
  Widget richText({
    ...
    text: TextSpan(text: this, style: style, children: children),
...
extension NumExtensions on num {
  ...
  BoxConstraints get constraints =>
      BoxConstraints.tightFor(width: toDouble(), height: toDouble());
